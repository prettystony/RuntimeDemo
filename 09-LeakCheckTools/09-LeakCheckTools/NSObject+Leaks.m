...
- (void) assertNotDealloc {
    ...
    NSString* message = [NSString stringWithFormat:@"Memory leaked. %@", className];
    UIAlertView* alert = [[UIAlertView alloc] initWithTitle:@"Leaked" message:message delegate:nil cancelButtonTitle:@"Cancel" otherButtonTitles:@"OK", nil];
    [alert show];
}
